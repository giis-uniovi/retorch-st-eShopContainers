pipeline {
  ...
  stages {
        ...
        stage('tjobb IdResource: basket-api catalog-api chrome-browser eshopUser identity-api webmvc ') {
          steps {
            catchError(buildResult: 'UNSTABLE', stageResult: 'FAILURE') {
              ...
              sh '$SCRIPTS_FOLDER/tjoblifecycles/tjob-testexecution.sh tjobb 0 http://webmvc_tjobb:80 "CatalogTests#addProductsToBasket"'
        ...
        stage('tjobc IdResource: basket-api eshopUser identity-api ') {
          steps {
            catchError(buildResult: 'UNSTABLE', stageResult: 'FAILURE') {
              ...
              sh '$SCRIPTS_FOLDER/tjoblifecycles/tjob-testexecution.sh tjobc 0 http://webmvc_tjobc:80 "DesktopAPIGatewayAPITests#testAddProductsBasket,DesktopAPIGatewayAPITests#testAddSingleBasketItem,DesktopAPIGatewayAPITests#testUpdateBasketItemQuantities"'
        ...
        stage('tjobd IdResource: basket-api catalog-api chrome-browser eshopUser identity-api ordering-api payment-api webmvc ') {
          steps {
            catchError(buildResult: 'UNSTABLE', stageResult: 'FAILURE') {
              ...
              sh '$SCRIPTS_FOLDER/tjoblifecycles/tjob-testexecution.sh tjobd 0 http://webmvc_tjobd:80 "OrderTests#testCancelOrder,OrderTests#testCreateNewOrder"'
            }// EndExecutionStageErrortjobd
            sh '$SCRIPTS_FOLDER/tjoblifecycles/tjob-teardown.sh tjobd 0'
          }// EndStepstjobd
        }// EndStagetjobd
        stage('tjobe IdResource: identity-api ordering-api ') {
          steps {
            catchError(buildResult: 'UNSTABLE', stageResult: 'FAILURE') {
              sh '$SCRIPTS_FOLDER/tjoblifecycles/tjob-setup.sh tjobe 0 http://webmvc_tjobe:80'
              sh '$SCRIPTS_FOLDER/tjoblifecycles/tjob-testexecution.sh tjobe 0 http://webmvc_tjobe:80 "OrderingAPIGatewayAPITests#testGetCardTypes,OrderingAPIGatewayAPITests#testGetOrderByNonExistentId"'
            }// EndExecutionStageErrortjobe
            sh '$SCRIPTS_FOLDER/tjoblifecycles/tjob-teardown.sh tjobe 0'
          }// EndStepstjobe
        }// EndStagetjobe
        stage('tjobf IdResource: basket-api eshopUser identity-api ') {
          steps {
            catchError(buildResult: 'UNSTABLE', stageResult: 'FAILURE') {
              sh '$SCRIPTS_FOLDER/tjoblifecycles/tjob-setup.sh tjobf 0 http://webmvc_tjobf:80'
              sh '$SCRIPTS_FOLDER/tjoblifecycles/tjob-testexecution.sh tjobf 0 http://webmvc_tjobf:80 "DesktopAPIGatewayAPITests#testGetOrderDraftFromNonExistentBasket"'
            }// EndExecutionStageErrortjobf
            sh '$SCRIPTS_FOLDER/tjoblifecycles/tjob-teardown.sh tjobf 0'
          }// EndStepstjobf
        }// EndStagetjobf
        stage('tjobg IdResource: payment-api ') {
          steps {
            catchError(buildResult: 'UNSTABLE', stageResult: 'FAILURE') {
              sh '$SCRIPTS_FOLDER/tjoblifecycles/tjob-setup.sh tjobg 0 http://webmvc_tjobg:80'
              sh '$SCRIPTS_FOLDER/tjoblifecycles/tjob-testexecution.sh tjobg 0 http://webmvc_tjobg:80 "PaymentAPITests#testPaymentHealthCheck,PaymentAPITests#testPaymentLiveness"'
    ...
    stage('Stage 1') {
      failFast false
      parallel {
        stage('tjobh IdResource: catalog-api chrome-browser eshopUser identity-api webmvc ') {
          steps {
            catchError(buildResult: 'UNSTABLE', stageResult: 'FAILURE') {
              sh '$SCRIPTS_FOLDER/tjoblifecycles/tjob-setup.sh tjobh 1 http://webmvc_tjobh:80'
              sh '$SCRIPTS_FOLDER/tjoblifecycles/tjob-testexecution.sh tjobh 1 http://webmvc_tjobh:80 "LoggedUserTest#loginTest"'
            }// EndExecutionStageErrortjobh
            sh '$SCRIPTS_FOLDER/tjoblifecycles/tjob-teardown.sh tjobh 1'
          }// EndStepstjobh
        }// EndStagetjobh
        stage('tjobi IdResource: catalog-api ') {
          steps {
            catchError(buildResult: 'UNSTABLE', stageResult: 'FAILURE') {
              sh '$SCRIPTS_FOLDER/tjoblifecycles/tjob-setup.sh tjobi 1 http://webmvc_tjobi:80'
              sh '$SCRIPTS_FOLDER/tjoblifecycles/tjob-testexecution.sh tjobi 1 http://webmvc_tjobi:80 "CatalogAPITests#testGetCatalogBrands,CatalogAPITests#testGetCatalogItemById,CatalogAPITests#testGetCatalogItems,CatalogAPITests#testGetCatalogItemsByName,CatalogAPITests#testGetCatalogItemsByTypeAndBrand,CatalogAPITests#testGetCatalogTypes"'
            }// EndExecutionStageErrortjobi
            sh '$SCRIPTS_FOLDER/tjoblifecycles/tjob-teardown.sh tjobi 1'
          }// EndStepstjobi
        }// EndStagetjobi
        stage('tjobj IdResource: eshopUser identity-api ') {
          steps {
            catchError(buildResult: 'UNSTABLE', stageResult: 'FAILURE') {
              sh '$SCRIPTS_FOLDER/tjoblifecycles/tjob-setup.sh tjobj 1 http://webmvc_tjobj:80'
              sh '$SCRIPTS_FOLDER/tjoblifecycles/tjob-testexecution.sh tjobj 1 http://webmvc_tjobj:80 "IdentityAPITests#testGetCurrentUserInfo,IdentityAPITests#testGetTokenWithValidCredentials"'
        ...
        stage('tjobl IdResource: eshopUser identity-api ordering-api ') {
          steps {
            catchError(buildResult: 'UNSTABLE', stageResult: 'FAILURE') {
              sh '$SCRIPTS_FOLDER/tjoblifecycles/tjob-setup.sh tjobl 1 http://webmvc_tjobl:80'
              sh '$SCRIPTS_FOLDER/tjoblifecycles/tjob-testexecution.sh tjobl 1 http://webmvc_tjobl:80 "OrderingAPIGatewayAPITests#testGetOrdersForUser"'
