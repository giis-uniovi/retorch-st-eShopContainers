...
public class Navigation {
    ...
    public static void toOrdersPage(WebDriver driver, Waiter waiter) throws ElementNotFoundException {
        ...
        try {
            ...
            logoutElement = driver.findElement(By.xpath("//*[@id=\"logoutForm\"]/section[2]/a[1]/div"));
            ...
            waiter.waitUntil(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"logoutForm\"]/section[2]/a[1]/div")),
                    "Orders link is not visible after expanding the menu");
            logoutElement = mainMenu.findElement(By.xpath("//*[@id=\"logoutForm\"]/section[2]/a[1]/div"));
        }
