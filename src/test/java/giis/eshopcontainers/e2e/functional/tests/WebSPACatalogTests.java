...
class WebSPACatalogTests extends BaseWebSPALoggedClass {
    ...
    void filterProductsByBrandTypeSPA() throws ElementNotFoundException {
        ...
        for (int brand : brands) {
            ...
            for (int type : types) {
                ...
                Assertions.assertEquals(expected, numberCatalogDisplayedItems(), "Brand: " + brandName + ", Type: " + typeName + ", Expected Items: " + expected);
            }
        }
    }
    ...
    public void selectFilter(String filterId, String[] filterOptions, Integer option) throws ElementNotFoundException {
        ...
        // Wait for pager UI element to show a different text arrives from the API and is displayed
        // (means that the filter was applied).
